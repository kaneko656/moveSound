...
class SoundManager {
  ...
  SoundManager(Minim _minim) {
    minim = _minim;
    createSoundObject(minim, "centerfront_flute.wav");
    createSoundObject(minim, "centerfront_oboe.wav");
    createSoundObject(minim, "centerfront_piano.wav");
    createSoundObject(minim, "centerfront_chorus.wav");
    createSoundObject(minim, "centerfront_violin.wav");
